const coupon = {
  ...
  // Alert messages
  NEXT_STEP: "Next Step",
  NEXT_STEP_EDIT_DESC: "After updating, you can manage detailed promotion information.",
  NEXT_STEP_CREATE_DESC: "New coupons will be hidden. After creation, you need to add detailed conditions before activating the promotion.",
  NOTE: "Note",
  NOTE_CREATE_DESC: "New coupons are always hidden for safety. You need to add at least one detailed condition before activation.",
  ...
  COUPON_CODE_PATTERN: "Code only contains uppercase letters, numbers, underscores and dashes!",
  ...
  COUPON_DETAIL_START_DATE_AFTER_PARENT_START: "Start date cannot be before parent coupon start date",
  COUPON_DETAIL_START_DATE_BEFORE_PARENT_END: "Start date cannot be after parent coupon end date", 
  COUPON_DETAIL_END_DATE_AFTER_PARENT_START: "End date cannot be before parent coupon start date",
  COUPON_DETAIL_END_DATE_BEFORE_PARENT_END: "End date cannot be after parent coupon end date",
  ...
  COUPON_DETAIL_DELETE_CONFIRM_CONTENT: "Are you sure you want to delete this coupon detail?",
