const coupon = {
  ...
  COUPON_STATISTICS_TITLE: "Coupon Performance Statistics",
  COUPON_STATISTICS_BREADCRUMB_REPORT: "Report",
  COUPON_STATISTICS_BREADCRUMB_TITLE: "Coupon Statistics",
  COUPON_STATISTICS_DATE_FROM: "From date",
  COUPON_STATISTICS_DATE_TO: "To date",
  COUPON_STATISTICS_EXPORT_BUTTON: "Export Report",
  COUPON_STATISTICS_EXPORT_SUCCESS: "Report exported successfully!",
  COUPON_STATISTICS_EXPORT_ERROR: "Failed to export report!",
  COUPON_STATISTICS_DETAIL_TITLE: "Coupon Performance Details",

  // Statistics Cards
  COUPON_STATISTICS_TOTAL_COUPONS: "Total Coupons",
  COUPON_STATISTICS_ACTIVE_COUPONS: "Active",
  COUPON_STATISTICS_UPCOMING_COUPONS: "Upcoming",
  COUPON_STATISTICS_EXPIRED_COUPONS: "Expired",
  COUPON_STATISTICS_TOTAL_REDEMPTIONS: "Total Redemptions",
  COUPON_STATISTICS_UNIQUE_CUSTOMERS: "Unique Customers",
  COUPON_STATISTICS_ORDERS_WITH_COUPONS: "Orders with Coupons",
  COUPON_STATISTICS_TOTAL_DISCOUNT_AMOUNT: "Total Discount Amount",
  COUPON_STATISTICS_REVENUE_BEFORE_DISCOUNT: "Revenue Before Discount",
  COUPON_STATISTICS_REVENUE_AFTER_DISCOUNT: "Revenue After Discount",
  COUPON_STATISTICS_COUPON_USAGE_RATE: "Coupon Usage Rate",
  COUPON_STATISTICS_ORDER_CONVERSION_RATE: "Order Conversion Rate",
  COUPON_STATISTICS_AVERAGE_DISCOUNT_PER_ORDER: "Avg Discount/Order",

  // Performance Table Columns
  COUPON_STATISTICS_TABLE_STT: "No.",
  COUPON_STATISTICS_TABLE_CODE: "Code",
  COUPON_STATISTICS_TABLE_NAME: "Coupon Name",
  COUPON_STATISTICS_TABLE_KIND: "Kind",
  COUPON_STATISTICS_TABLE_VALIDITY: "Validity Period",
  COUPON_STATISTICS_TABLE_USAGE_COUNT: "Usage Count",
  COUPON_STATISTICS_TABLE_UNIQUE_CUSTOMERS: "Customers",
  COUPON_STATISTICS_TABLE_TOTAL_DISCOUNT: "Total Discount",
  COUPON_STATISTICS_TABLE_REVENUE_BEFORE: "Revenue Before",
  COUPON_STATISTICS_TABLE_REVENUE_AFTER: "Revenue After",
  COUPON_STATISTICS_TABLE_DISCOUNT_PERCENTAGE: "Discount %",
  COUPON_STATISTICS_TABLE_STATUS: "Status",
  COUPON_STATISTICS_TABLE_TOTAL: "Total {{total}} coupons",

  // Performance Table Filter Values
  COUPON_STATISTICS_FILTER_ACTIVE: "Active",
  COUPON_STATISTICS_FILTER_INACTIVE: "Inactive",
  COUPON_STATISTICS_FILTER_UPCOMING: "Upcoming",
  COUPON_STATISTICS_FILTER_EXPIRED: "Expired",
};
