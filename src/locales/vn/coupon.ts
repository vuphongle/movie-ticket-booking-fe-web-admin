const coupon = {
  ...
  NEXT_STEP_EDIT_DESC: "Sau khi cập nhật, bạn có thể quản lý thông tin chi tiết khuyến mại.",
  NEXT_STEP_CREATE_DESC: "Coupon mới tạo sẽ ở trạng thái ẩn. Sau khi tạo, bạn cần thêm điều kiện chi tiết trước khi có thể kích hoạt khuyến mại.",
  NOTE: "Lưu ý",
  NOTE_CREATE_DESC: "Coupon mới tạo luôn có trạng thái ẩn để đảm bảo an toàn. Bạn cần thêm ít nhất một điều kiện chi tiết trước khi có thể kích hoạt.",
  ...
  COUPON_DETAIL_START_DATE_AFTER_PARENT_START: "Ngày bắt đầu không thể trước ngày bắt đầu của coupon cha",
  COUPON_DETAIL_START_DATE_BEFORE_PARENT_END: "Ngày bắt đầu không thể sau ngày kết thúc của coupon cha", 
  COUPON_DETAIL_END_DATE_AFTER_PARENT_START: "Ngày kết thúc không thể trước ngày bắt đầu của coupon cha",
  COUPON_DETAIL_END_DATE_BEFORE_PARENT_END: "Ngày kết thúc không thể sau ngày kết thúc của coupon cha",
  ...
  COUPON_DETAIL_DELETE_CONFIRM_CONTENT: "Bạn có chắc chắn muốn xóa chi tiết khuyến mại này?",
  ...
  START_DATE_BEFORE_END_DATE: "Ngày bắt đầu phải trước hoặc bằng ngày kết thúc!",
