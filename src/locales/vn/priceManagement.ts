const priceManagement = {
  ...
  SEAT_TYPE_TOOLTIP:
    "Chọn loại ghế mà giá này áp dụng. Để trống để áp dụng cho tất cả loại ghế",
  GRAPHICS_TYPE_TOOLTIP:
    "Chọn định dạng phim mà giá này áp dụng (2D, 3D, v.v.). Để trống để áp dụng cho tất cả định dạng",
  SCREENING_TIME_TYPE_TOOLTIP:
    "Chọn khung thời gian mà giá này áp dụng (sáng, chiều, tối). Để trống để áp dụng cho tất cả khung giờ",
  DAY_TYPE_TOOLTIP:
    "Chọn loại ngày mà giá này áp dụng (ngày thường, cuối tuần, lễ). Để trống để áp dụng cho tất cả ngày",
  AUDITORIUM_TYPE_TOOLTIP:
    "Chọn loại phòng chiếu mà giá này áp dụng (tiêu chuẩn, IMAX, v.v.). Để trống để áp dụng cho tất cả loại phòng",
  MIN_QUANTITY_TOOLTIP:
    "Số lượng tối thiểu cần thiết để áp dụng giá này. Để trống nếu không có yêu cầu tối thiểu",
  SIMULATE_AT_TOOLTIP:
    "Đặt ngày và giờ để mô phỏng giá nhằm kiểm tra cách thức hoạt động của quy tắc tính giá tại các thời điểm khác nhau",
  ...
  CLONE_CONFIRM_CONTENT:
    "Bạn có chắc chắn muốn nhân bản '{{name}}'? Việc này sẽ tạo một bản sao của bảng giá và tất cả các mục giá bên trong.",
