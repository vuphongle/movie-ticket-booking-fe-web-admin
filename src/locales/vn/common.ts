const common = {
  ...
  DELETE_ACTOR: "Xóa diễn viên",
  ACTOR_DETAIL: "Chi tiết diễn viên",
  AVATAR: "Ảnh đại diện",
  NAME: "Tên",
  BIRTHDAY: "Ngày sinh",
  ...
  BIO: "Tiểu sử",
  ACTOR_CREATED_SUCCESS: "Tạo diễn viên thành công!",
  ACTOR_UPDATED_SUCCESS: "Cập nhật diễn viên thành công!",
  ACTOR_DELETED_SUCCESS: "Xóa diễn viên thành công!",
  CONFIRM_DELETE_ACTOR: "Bạn có chắc chắn muốn xóa diễn viên này?",
  NAME_REQUIRED: "Tên là bắt buộc!",
  NAME_MAX_LENGTH: "Tên không được vượt quá 50 ký tự!",
  BIRTH_DATE_REQUIRED: "Ngày sinh là bắt buộc!",
  BIO_REQUIRED: "Tiểu sử là bắt buộc!",
  ENTER_NAME: "Nhập tên",
  ENTER_BIO: "Nhập tiểu sử",
  BIRTH_DATE_FUTURE_ERROR: "Ngày sinh không thể ở tương lai!",
  BIO_MIN_LENGTH: "Tiểu sử phải có ít nhất 10 ký tự!",
  BIO_MAX_LENGTH: "Tiểu sử không được vượt quá 500 ký tự!",
  CHANGE_ACTOR_IMAGE: "Thay đổi ảnh diễn viên",
