const showtimes = {
    ...
    SLOT_OCCUPANCY_WARNING: "Phim này sẽ chiếm {count} ca liên tiếp (để tránh xung đột lịch chiếu)",
    ...
    BULK_CREATION_SUCCESS: "Đã tạo thành công {{created}} trên {{total}} suất chiếu",
    BULK_CREATION_PARTIAL: "Đã tạo {{created}} suất chiếu, bỏ qua {{skipped}} do xung đột",
    BULK_CREATION_FAILED: "Không thể tạo suất chiếu nào. Vui lòng kiểm tra lại lịch chiếu.",
